...
#
# Script Description: Same as script 11a, but includes quadratic terms for
# broadleaf and coniferous cover to check non-linearity
#
...
inlabruCmp  <-  presence ~ 0 + Intercept(1) +
  ...
  connectivity(main = connW_scaled,
               main_layer = iYear,
               model = "linear") +
  # Add quadratic terms for supplementary analysis
  coverBF_quad(main = coverBF_scaled^2,
               main_layer = iYear,
               model = "linear") +
  coverCF_quad(main = coverCF_scaled^2,
               main_layer = iYear,
               model = "linear") +
...
linearEffLabels <- c('coverBF' = "Broadleaf cover",
                     ...
                     'coverCF_quad' = "Broadleaf cover quadratic",
                     'coverBF_quad' = "Broadleaf cover quadratic",
...
iSpeciesDir <- paste0("Treescapes/ST_SDMs/Output/Supplementary_quadratic_analysis/", 
                      taxaGroup, "/", 
                      iSpeciesTidy)
